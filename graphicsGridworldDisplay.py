...
class GraphicsGridworldDisplay:
    ...
    def displayValuesGivenAgent(self, agent, currentState = None, message = 'Agent Values'):
        values = util.Counter()
        policy = {}
    ...
    def displayQValuesGivenAgent(self, agent, currentState = None, message = 'Agent Q-Values'):
    ...
    def displayQValues(self, qValues, currentState = None, message = 'Agent Q-Values'):
        drawQValues(self.gridworld, qValues, currentState, message)
        sleep(0.05 / self.speed)
