...
# Modified by Baris Akgun (baakgun@ku.edu.tr) for his RL class.
...
class TextGridworldDisplay:
    ...
    def displayValuesGivenAgent(self, agent, currentState = None, message = None):
        if message != None:
            print (message)
        values = util.Counter()
        policy = {}
    ...
    def displayValues(self, values, policy = None, currentState = None, message = None):
        prettyPrintValues(self.gridworld, values, policy, currentState)
    ...
    def displayQValuesGivenAgent(self, agent, currentState = None, message = None):
        if message != None: print (message)
    ...
    def displayQValuesGivenAgent(self, qValues, currentState = None, message = None):
        if message != None: print (message)
        prettyPrintQValues(self.gridworld, qValues, currentState)
...
def indent(rows, hasHeader=False, headerChar='-', delim=' | ', justify='left',
    ...
    output=io.StringIO()
    if separateRows: print(rowSeparator, file=output) #print >> output, rowSeparator
